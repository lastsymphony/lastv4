...
global.owner = ['6289670394574','6285823554146','6285747874973','6285762005157','6281319352377','6282273025238','6285240424044','628983100508','62895433996700','62895618689182','6281233976038'] // Put your number here
  ...
  try {
    ...
    try {
      ...
      if (user = global.DATABASE._data.users[m.sender]) {
        ...
        exp: 99999999999999999999999999999999999999999999999,
        limit: 999999999999999999999999999999999999999999999999999,
        lastclaim: 0,
        registered: false,
    ...
    let isBotAdmin = bot.isAdmin || bot.isSuperAdmin || false // Are you Admin?
      ...
      if (typeof plugin.before == 'function') if (await plugin.before.call(this, m, {
        ...
        if (xp > 999) m.reply('_ADITYA JATAYU☻_  *BROKEN HOME*😞💔 ') // Hehehe
        else m.exp += xp
        ...
        try {
          ...
          if (m.limit) m.reply(+ m.limit + ' Limit terpakai ya Onii-Chan 😘')
        }
  			break
  		}
  	}
